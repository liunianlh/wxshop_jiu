<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\store\user\index.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (($store['user']['store_user_id'] != $item['store_user_id'])
                                                && !$item['is_super']): if (checkPrivilege('store.user/edit')): ?>
                                                    <a href="<?= url('store.user/edit', ['user_id' => $item['store_user_id']]) ?>">
                                                        <i class="am-icon-pencil"></i> 编辑
                                                    </a>
                                                <?php endif; if (checkPrivilege('store.user/delete')): ?>
                                                    <a href="javascript:void(0);"
