<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\setting\trade.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-input-group">
                                    ...
                                    <label class="am-u-sm-6 am-form-label am-text-left">天后自动关闭</label>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-input-group">
                                    ...
                                    <label class="am-u-sm-6 am-form-label am-text-left">天后自动确认收货</label>
                                    <div class="help-block am-u-sm-12">
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require">已完成订单 </label>
                                <div class="am-u-sm-9 am-input-group">
                                    <div class="am-u-sm-6">
                                        <input type="number" class="am-form-field" name="trade[order][refund_days]"
                                               value="<?= $values['order']['refund_days'] ?>" required>
                                    </div>
                                    <label class="am-u-sm-6 am-form-label am-text-left">天内允许申请售后</label>
                                    <div class="help-block am-u-sm-12">
                                        <small>订单完成后 ，用户在n天内可以发起售后申请，设置0天不允许申请售后</small>
                                    </div>
                                </div>
                            </div>
