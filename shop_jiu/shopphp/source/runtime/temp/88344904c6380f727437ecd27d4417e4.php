<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\wxapp\page\links.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="widget-body">
                    ...
                    <div class="link-list">
                        <ul class="">
                            ...
                            <li class="link-item">
                                <div class="row page-name">分销中心</div>
                                <div class="row am-cf">
                                    <div class="am-fl">地址：</div>
                                    <div class="am-fl">
                            ...
                            <li class="link-item">
                                <div class="row page-name">领券中心</div>
                                <div class="row am-cf">
                                    <div class="am-fl">地址：</div>
                                    <div class="am-fl">
                            ...
                            <li class="link-item">
                                <div class="row page-name">我的优惠券</div>
                                <div class="row am-cf">
                                    <div class="am-fl">地址：</div>
                                    <div class="am-fl">
