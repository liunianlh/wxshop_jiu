<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\store\role\index.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="widget-body am-fr">
                    ...
                    <div class="page_toolbar am-margin-bottom-xs am-cf">
                        <div class="am-form-group">
                            <?php if (checkPrivilege('store.role/add')): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('store.role/edit')): ?>
                                                <a href="<?= url('store.role/edit', ['role_id' => $item['role_id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; if (checkPrivilege('store.role/delete')): ?>
                                                <a href="javascript:void(0);"
