<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\setting\cache\clear.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <div class="help-block">
                                            <small class="x-color-red">此操作将会强制清空缓存目录，包含用户授权登录状态、用户购物车数据，仅允许在开发环境中使用
                                            </small>
                                        </div>
                                    </div>
                                </div>
