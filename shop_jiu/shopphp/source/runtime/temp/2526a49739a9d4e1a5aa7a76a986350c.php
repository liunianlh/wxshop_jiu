<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\wxapp\setting.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="am-form-group am-padding-top">
                                ...
                                <div class="am-u-sm-9">
                                     <textarea rows="6" name="wxapp[cert_pem]"
                                               placeholder="使用文本编辑器打开apiclient_cert.pem文件，将文件的全部内容复制进来"><?= $wxapp['cert_pem'] ?></textarea>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                     <textarea rows="6" name="wxapp[key_pem]"
                                               placeholder="使用文本编辑器打开apiclient_key.pem文件，将文件的全部内容复制进来"><?= $wxapp['key_pem'] ?></textarea>
