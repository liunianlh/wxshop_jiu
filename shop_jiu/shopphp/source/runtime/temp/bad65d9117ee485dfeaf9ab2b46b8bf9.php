<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\goods\comment\index.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('goods.comment/detail')): ?>
                                                <a href="<?= url('goods.comment/detail', ['comment_id' => $item['comment_id']]) ?>">
