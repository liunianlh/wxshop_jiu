<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\setting\delivery\index.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                        <div class="am-form-group">
                            <div class="am-btn-toolbar">
                                <?php if (checkPrivilege('setting.delivery/add')): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="am-text-middle">
                                            <div class="tpl-table-black-operation">
                                                ...
                                                <?php endif; if (checkPrivilege('setting.delivery/delete')): ?>
                                                    <a href="javascript:;"
