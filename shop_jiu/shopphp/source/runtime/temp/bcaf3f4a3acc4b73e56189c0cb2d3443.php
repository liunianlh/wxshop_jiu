<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\wxapp\page\index.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php endif; if ($item['page_type'] == 20) : if (checkPrivilege('wxapp.page/delete')): ?>
                                                    <a href="javascript:;"
                                                       class="item-delete tpl-table-black-operation-del"
                                                       data-id="<?= $item['page_id'] ?>">
                                                        <i class="am-icon-trash"></i> 删除
                                                    </a>
                                                <?php endif; if (checkPrivilege('wxapp.page/sethome')): ?>
                                                    <a href="javascript:;"
