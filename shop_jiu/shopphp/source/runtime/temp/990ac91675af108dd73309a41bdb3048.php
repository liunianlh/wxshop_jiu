<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"F:\phpStudy\WWW\shopphp\web/../source/application/store\view\wxapp\page\category.php";i:1542766297;s:72:"F:\phpStudy\WWW\shopphp\source\application\store\view\layouts\layout.php";i:1551167251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="wrapper am-container">
                                <div class="left-style am-u-sm-12 am-u-md-12 am-u-lg-4">
                                    <img class="img__category_style"
                                         src="assets/store/img/categoryTpl_<?= $model['category_style'] ?>.png">
                                </div>
...
<script>
    $(function () {
        ...
        $("input[name='category[category_style]']").change(function (e) {
            ...
            $imgCategorystyle.attr('src', 'assets/store/img/categoryTpl_' + styleValue + '.png');
        });
