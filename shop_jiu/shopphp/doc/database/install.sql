...
INSERT INTO `yoshop_delivery` VALUES ('10001', '全国包邮', '10', '10001', '100', '1535083514', '1535083514');
...
INSERT INTO `yoshop_express` VALUES ('10001', '顺丰速运', 'shunfeng', '100', '10001', '1535160797', '1535160797');
INSERT INTO `yoshop_express` VALUES ('10002', '邮政国内', 'yzguonei', '100', '10001', '1535942653', '1535942653');
INSERT INTO `yoshop_express` VALUES ('10003', '圆通速递', 'yuantong', '100', '10001', '1535942675', '1535942675');
INSERT INTO `yoshop_express` VALUES ('10004', '申通快递', 'shentong', '100', '10001', '1535942694', '1535942694');
INSERT INTO `yoshop_express` VALUES ('10005', '韵达快递', 'yunda', '100', '10001', '1535942711', '1535942711');
INSERT INTO `yoshop_express` VALUES ('10006', '百世快递', 'huitongkuaidi', '100', '10001', '1535942743', '1535942743');
INSERT INTO `yoshop_express` VALUES ('10007', '中通快递', 'zhongtong', '100', '10001', '1535942764', '1535942764');
INSERT INTO `yoshop_express` VALUES ('10008', '天天快递', 'tiantian', '100', '10001', '1535942783', '1535942783');
INSERT INTO `yoshop_express` VALUES ('10009', '宅急送', 'zhaijisong', '100', '10001', '1535942798', '1535942798');
...
INSERT INTO `yoshop_setting` VALUES ('storage', '上传设置', '{\"default\":\"local\",\"engine\":{\"qiniu\":{\"bucket\":\"\",\"access_key\":\"\",\"secret_key\":\"\",\"domain\":\"http:\\/\\/\"},\"aliyun\":{\"bucket\":\"\",\"access_key_id\":\"\",\"access_key_secret\":\"\",\"domain\":\"http:\\/\\/\"},\"qcloud\":{\"bucket\":\"\",\"region\":\"\",\"secret_id\":\"\",\"secret_key\":\"\",\"domain\":\"http:\\/\\/\"}}}', '10001', '1535945598');
...
INSERT INTO `yoshop_store_user` VALUES ('10001', 'admin', '9ae7b2e6f25c907a1fc81b503b16e25f', '管理员', '1', '0', '10001', '1529926348', '1531027042');
...
CREATE TABLE `yoshop_user` (
  ...
  `money`  decimal(10,2) unsigned NOT NULL DEFAULT 0 COMMENT '用户总消费金额',
  `is_delete` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
...
CREATE TABLE `yoshop_user_address` (
  ...
  `city_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '所在城市id',
  `region_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '所在区id',
  `district`  varchar(255) NULL DEFAULT '' COMMENT '新市辖区(该字段用于记录region表中没有的市辖区)',
  `detail` varchar(255) NOT NULL DEFAULT '' COMMENT '详细地址',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
...
INSERT INTO `yoshop_wxapp` VALUES ('10001', '', '', '', '', '', '', 0, 0, '1529926348', '1532766653');
...
INSERT INTO `yoshop_wxapp_help` VALUES ('10001', '关于小程序', '小程序本身无需下载，无需注册，不占用手机内存，可以跨平台使用，响应迅速，体验接近原生APP。', '100', '10001', '1535942481', '1535942481');
...
INSERT INTO `yoshop_store_access` VALUES ('10108', '审核用户取消申请', 'order.operate/confirmcancel', '10043', '100', '1542163260', '1542163260');
INSERT INTO `yoshop_store_access` VALUES ('10109', '售后管理', 'order.refund', '10035', '100', '1542161684', '1542161684');
INSERT INTO `yoshop_store_access` VALUES ('10110', '售后列表', 'order.refund/index', '10108', '100', '1542161714', '1542161714');
INSERT INTO `yoshop_store_access` VALUES ('10111', '售后详情', 'order.refund/detail', '10108', '100', '1542161736', '1542161736');
INSERT INTO `yoshop_store_access` VALUES ('10112', '审核售后单', 'order.refund/audit', '10108', '100', '1542162196', '1542162196');
INSERT INTO `yoshop_store_access` VALUES ('10113', '确认收货并退款', 'order.refund/receipt', '10108', '100', '1542162231', '1542162231');

INSERT INTO `yoshop_store_access` (`name`, `url`, `parent_id`, `sort`, `create_time`, `update_time`) VALUES ('退货地址管理', 'setting.address', '10090', '100', '1542609573', '1542609573');
INSERT INTO `yoshop_store_access` (`name`, `url`, `parent_id`, `sort`, `create_time`, `update_time`) VALUES ('退货地址列表', 'setting.address/index', '10114', '100', '1542609598', '1542609598');
INSERT INTO `yoshop_store_access` (`name`, `url`, `parent_id`, `sort`, `create_time`, `update_time`) VALUES ('新增退货地址', 'setting.address/add', '10114', '100', '1542609630', '1542609630');
INSERT INTO `yoshop_store_access` (`name`, `url`, `parent_id`, `sort`, `create_time`, `update_time`) VALUES ('编辑退货地址', 'setting.address/edit', '10114', '100', '1542609656', '1542609656');
INSERT INTO `yoshop_store_access` (`name`, `url`, `parent_id`, `sort`, `create_time`, `update_time`) VALUES ('删除退货地址', 'setting.address/delete', '10114', '100', '1542609680', '1542609680');
